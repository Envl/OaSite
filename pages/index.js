  ...
  return (
    <div className={`posts ${props.className ? props.className : ''}`}>
      {[
        ...
        {title: 'ShopWalker', coverUrl: '/shopwalker.png', tags: ['App', 'UX']},
        {
          title: 'Tetris.Dual',
          coverUrl: '/tetris.png',
        ...
        },
        {
          ...
          tags: ['Tangible Interaction', 'Installation', 'Kinect'],
        },
        {
          title: 'Boccaro',
        ...
        },
        {
          ...
          tags: ['Tangible Interaction', 'Kinect'],
          url: 'https://youtu.be/YkSXkH7YLoE',
        },
        {
          title: 'Digi Cemetery',
          coverUrl: '/cemetery.png',
          brief:
            'A website includes memorable products that died in recent years.',
          tags: ['UX', 'Web', 'WIP'],
